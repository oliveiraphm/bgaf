...
@app.post("/upload")
async def file_upload_controller(file: Annotated[UploadFile, File(description="Uploaded PDF documents")]):
...
if st.button("Submit"):
    if file is not None:
        ...
        response = requests.posts("http://localhost:8000/upload", files=files)
